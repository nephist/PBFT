...
public class Servicio {
	...
	//Esto no existir� se hara con el .txt en Servicio
	...
	public String inicio(@QueryParam("propuesta") int propuesta) {
        ...
        return valoresRecibidos.toString(); // Enviar� algo como "[10, 10]"
    }
	...
	public String estado() {
		/*	por cada proceso que nos env�a una string del tipo "2/1/1,1,8/false"
		 * 	los separamos por ";"
		 * 		EJEMPLO:
		 * 			3 procesos
